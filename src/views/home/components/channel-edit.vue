...
export default {
  ...
  computed: {
    ...
    computedMyChannels () {
      // 这里直接return引用数据类型obj，此时computedMyChannels相当于myChannels
  ...
  methods: {
    ...
    async onAddChannel (channel) {
      this.computedMyChannels.push(channel)
      ...
      if (this.user) {
        ...
        // 未登录，把数据存储到本地
        console.log('未登录', this.myChannels)
    ...
    onMyChannelClick (channel, index) {
      if (this.isEdit) {
        ...
        this.computedMyChannels.splice(index, 1)
